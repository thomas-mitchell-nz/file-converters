...
def convert_mov_to_mp4_with_metadata(source_folder, target_folder=None):
    ...
    for filename in os.listdir(source_folder):
        if filename.endswith(".mov") or filename.endswith(".MOV"):
            ...
            try:
                ...
                # Convert .mov to .mp4 and set creation_time if available
                if creation_time:
...
if __name__ == "__main__":
    source_folder = 'file-converters/mov'
    target_folder = 'file-converters/mp4'
    convert_mov_to_mp4_with_metadata(source_folder, target_folder)
